...
export default function Home() {
  ...
  const goToProducts = () => {
    navigate("/product"); // change this to match your actual Product route
  };
    ...
    <>
      <div className="bg-black grid grid-cols-1 lg:grid-cols-3 items-center ">
        ...
        <div className="lg:col-span-2 px-6 sm:px-10 lg:px-20 py-12 text-center lg:text-left">
          <h1
            className="text-[rgb(217,83,0)] font-bold
          ...
          <button
            ...
            className="mt-8 bg-[rgb(217,83,0)] text-black font-bold
      ...
      <div className="relative py-28 overflow-hidden">
        ...
        <div className="relative z-10 flex justify-center">
          <div className="text-center px-6 max-w-4xl">
            ...
            <h1
              className="mt-4 font-bold text-[#d95300] leading-tight
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
              <button
                onClick={goToProducts}
                className="px-8 py-3 rounded-full bg-[#d95300] text-black font-semibold hover:scale-105 transition"
              >
                Shop Now
              </button>
              ...
              <button
                onClick={goToProducts}
                className="px-8 py-3 rounded-full border border-[#d95300] text-[#d95300] hover:bg-[#d95300] hover:text-black transition"
              >
                Explore Collection
              </button>
            </div>
